...
<div class="topTab" style="margin-top: 0px;">
        ...
        <div class="col-md-4">
                <label class="control-label">Tax Name(&nbsp;<span class="text text-danger">*</span>)</label>
                ...
                <div class="col-md-4">
                <label class="control-label">Tax Percentage(&nbsp;<span class="text text-danger">*</span>)</label>
                <input type="text" name="texPercentage" class="form-control" id="texPercentage" required="required">
                </div><div class="col-md-4">
               <label class="control-label">Tax Type(&nbsp;<span class="text text-danger">*</span>)</label>
              ...
              <option value="purchase">Purchase</option>
                ...
                <div class="col-md-4">
                <label class="control-label">SGST(&nbsp;<span class="text text-danger">*</span>)</label>
                <input type="text" name="sgst" class="persant form-control" id="sgst" required="required">
         </div><div class="col-md-4">
                <label class="control-label">CGST(&nbsp;<span class="text text-danger">*</span>)</label>
                <input type="text" name="cgst" class="persant form-control" id="cgst" required="required">
                </div><div class="col-md-4">
                <label class="control-label">IGST(&nbsp;<span class="text text-danger">*</span>)</label>
