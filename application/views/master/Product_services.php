  ...
  <div id="errorMessage"></div>
    ...
    <form id="productForm" method="POST" enctype="multipart/form-data">            
               ...
               <div class="col-md-12 text text-danger">
                ...
                <div class="col-md-3">
                <label class="control-label">Product Code(&nbsp;<span class="text text-danger">*</span>)/label>
              ...
              <div class="col-md-3">
                <label class="control-label">Product Group(&nbsp;<span class="text text-danger">*</span>)</label>
                <input type="text" name="productGroup" class="form-control" id="productGroup">
              </div>
              <div class="col-md-3">
                        <label class="control-label">Product Name(&nbsp;<span class="text text-danger">*</span>)</label>
                        <input type="text" name="productName" class="form-control" id="productName">
              </div>
              <div class="col-md-3">
                        <label class="control-label">Product Type(&nbsp;<span class="text text-danger">*</span>)</label>
