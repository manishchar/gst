...
<form method="post" action="<?php echo base_url('Company/change_password');?>">
 <div class="col-md-12 text text-danger">
          ...
          <div class="content p-4" >
              ...
              <div class="row form-group ">
                    <div class="col-md-12">
                   <label><b>New Password(&nbsp;<span class="text text-danger">*</span>)</b><?php //echo validation_errors('newpass'); ?></label>
                       <input type="password" name="newpass" placeholder="Enter New Password" id="" class="form-control" >
                     </div>
              </div>
              <div class="row form-group ">
                     <div class="col-md-12">
                      <label><b>New Password(&nbsp;<span class="text text-danger">*</span>)</b><?php //echo validation_errors('confpassword'); ?></label>
